    ...
    try {
        await chrome.scripting.executeScript({
            ...
            func: (data) => {
                ...
                // Δήμοι - Γενική → Ονομαστική
                const genitiveToNominative = (genitive: string): string => {
                    if (!genitive) return "";

                    const upper = genitive.trim().toUpperCase();

                    // Αν έχει παύλες, σπάσε και μετέτρεψε κάθε κομμάτι
                    if (upper.includes('-')) {
                        return genitive.split('-')
                            .map(part => genitiveToNominative(part.trim()))
                            .join('-');
                    }

                    const exceptions: Record<string, string> = {
                        // ΑΤΤΙΚΗ - Κεντρικός Τομέας
                        "ΑΘΗΝΑΙΩΝ": "Αθήνα", "ΑΘΗΝΩΝ": "Αθήνα", "ΒΥΡΩΝΟΣ": "Βύρωνας", "ΓΑΛΑΤΣΙΟΥ": "Γαλάτσι",
                        "ΔΑΦΝΗΣ": "Δάφνη", "ΥΜΗΤΤΟΥ": "Υμηττός", "ΖΩΓΡΑΦΟΥ": "Ζωγράφου", "ΗΛΙΟΥΠΟΛΗΣ": "Ηλιούπολη",
                        "ΚΑΙΣΑΡΙΑΝΗΣ": "Καισαριανή", "ΦΙΛΑΔΕΛΦΕΙΑΣ": "Φιλαδέλφεια", "ΧΑΛΚΗΔΟΝΟΣ": "Χαλκηδόνα",
                        "ΝΕΑΣ ΦΙΛΑΔΕΛΦΕΙΑΣ": "Νέα Φιλαδέλφεια",

                        // ΑΤΤΙΚΗ - Βόρειος Τομέας
                        "ΑΓΙΑΣ ΠΑΡΑΣΚΕΥΗΣ": "Αγία Παρασκευή", "ΑΜΑΡΟΥΣΙΟΥ": "Μαρούσι", "ΜΑΡΟΥΣΙΟΥ": "Μαρούσι",
                        "ΒΡΙΛΗΣΣΙΩΝ": "Βριλήσσια", "ΗΡΑΚΛΕΙΟΥ": "Ηράκλειο", "ΝΕΟΥ ΗΡΑΚΛΕΙΟΥ": "Νέο Ηράκλειο",
                        "ΚΗΦΙΣΙΑΣ": "Κηφισιά", "ΛΥΚΟΒΡΥΣΗΣ": "Λυκόβρυση", "ΠΕΥΚΗΣ": "Πεύκη",
                        "ΜΕΤΑΜΟΡΦΩΣΕΩΣ": "Μεταμόρφωση", "ΜΕΤΑΜΟΡΦΩΣΗΣ": "Μεταμόρφωση",
                        "ΝΕΑΣ ΙΩΝΙΑΣ": "Νέα Ιωνία", "ΠΑΠΑΓΟΥ": "Παπάγου", "ΧΟΛΑΡΓΟΥ": "Χολαργός",
                        "ΠΕΝΤΕΛΗΣ": "Πεντέλη", "ΦΙΛΟΘΕΗΣ": "Φιλοθέη", "ΨΥΧΙΚΟΥ": "Ψυχικό", "ΧΑΛΑΝΔΡΙΟΥ": "Χαλάνδρι",

                        // ΑΤΤΙΚΗ - Δυτικός Τομέας
                        "ΑΓΙΑΣ ΒΑΡΒΑΡΑΣ": "Αγία Βαρβάρα", "ΑΓΙΩΝ ΑΝΑΡΓΥΡΩΝ": "Άγιοι Ανάργυροι",
                        "ΚΑΜΑΤΕΡΟΥ": "Καματερό", "ΑΙΓΑΛΕΩ": "Αιγάλεω", "ΙΛΙΟΥ": "Ίλιον",
                        "ΠΕΡΙΣΤΕΡΙΟΥ": "Περιστέρι", "ΠΕΤΡΟΥΠΟΛΗΣ": "Πετρούπολη", "ΧΑΪΔΑΡΙΟΥ": "Χαϊδάρι",

                        // ΑΤΤΙΚΗ - Νότιος Τομέας
                        "ΑΓΙΟΥ ΔΗΜΗΤΡΙΟΥ": "Άγιος Δημήτριος", "ΑΛΙΜΟΥ": "Άλιμος", "ΓΛΥΦΑΔΑΣ": "Γλυφάδα",
                        "ΕΛΛΗΝΙΚΟΥ": "Ελληνικό", "ΑΡΓΥΡΟΥΠΟΛΗΣ": "Αργυρούπολη", "ΚΑΛΛΙΘΕΑΣ": "Καλλιθέα",
                        "ΜΟΣΧΑΤΟΥ": "Μοσχάτο", "ΤΑΥΡΟΥ": "Ταύρος", "ΝΕΑΣ ΣΜΥΡΝΗΣ": "Νέα Σμύρνη",
                        "ΠΑΛΑΙΟΥ ΦΑΛΗΡΟΥ": "Παλαιό Φάληρο",

                        // ΑΤΤΙΚΗ - Ανατολική
                        "ΑΧΑΡΝΩΝ": "Αχαρνές", "ΑΧΑΡΝΑΙ": "Αχαρνές", "ΒΑΡΗΣ": "Βάρη", "ΒΟΥΛΑΣ": "Βούλα",
                        "ΒΟΥΛΙΑΓΜΕΝΗΣ": "Βουλιαγμένη", "ΔΙΟΝΥΣΟΥ": "Διόνυσος", "ΚΡΩΠΙΑΣ": "Κρωπία",
                        "ΛΑΥΡΕΩΤΙΚΗΣ": "Λαυρεωτική", "ΜΑΡΑΘΩΝΟΣ": "Μαραθώνας", "ΜΑΡΚΟΠΟΥΛΟΥ": "Μαρκόπουλο",
                        "ΠΑΙΑΝΙΑΣ": "Παιανία", "ΠΑΛΛΗΝΗΣ": "Παλλήνη", "ΡΑΦΗΝΑΣ": "Ραφήνα",
                        "ΠΙΚΕΡΜΙΟΥ": "Πικέρμι", "ΣΑΡΩΝΙΚΟΥ": "Σαρωνικός", "ΣΠΑΤΩΝ": "Σπάτα",
                        "ΑΡΤΕΜΙΔΟΣ": "Αρτέμιδα", "ΩΡΩΠΟΥ": "Ωρωπός", "ΓΕΡΑΚΑ": "Γέρακας",

                        // ΑΤΤΙΚΗ - Δυτική
                        "ΑΣΠΡΟΠΥΡΓΟΥ": "Ασπρόπυργος", "ΕΛΕΥΣΙΝΑΣ": "Ελευσίνα", "ΜΑΝΔΡΑΣ": "Μάνδρα",
                        "ΜΕΓΑΡΕΩΝ": "Μέγαρα", "ΜΕΓΑΡΩΝ": "Μέγαρα", "ΦΥΛΗΣ": "Φυλή",

                        // ΑΤΤΙΚΗ - Πειραιάς
                        "ΠΕΙΡΑΙΩΣ": "Πειραιάς", "ΠΕΙΡΑΙΑ": "Πειραιάς", "ΚΕΡΑΤΣΙΝΙΟΥ": "Κερατσίνι",
                        "ΔΡΑΠΕΤΣΩΝΑΣ": "Δραπετσώνα", "ΚΟΡΥΔΑΛΛΟΥ": "Κορυδαλλός", "ΝΙΚΑΙΑΣ": "Νίκαια",
                        "ΠΕΡΑΜΑΤΟΣ": "Πέραμα",

                        // ΑΤΤΙΚΗ - Νήσοι
                        "ΑΙΓΙΝΑΣ": "Αίγινα", "ΚΥΘΗΡΩΝ": "Κύθηρα", "ΣΑΛΑΜΙΝΑΣ": "Σαλαμίνα",
                        "ΣΠΕΤΣΩΝ": "Σπέτσες", "ΥΔΡΑΣ": "Ύδρα", "ΠΟΡΟΥ": "Πόρος",

                        // ΘΕΣΣΑΛΟΝΙΚΗ
                        "ΘΕΣΣΑΛΟΝΙΚΗΣ": "Θεσσαλονίκη", "ΑΜΠΕΛΟΚΗΠΩΝ": "Αμπελόκηποι", "ΜΕΝΕΜΕΝΗΣ": "Μενεμένη",
                        "ΒΟΛΒΗΣ": "Βόλβη", "ΘΕΡΜΑΪΚΟΥ": "Θερμαϊκός", "ΘΕΡΜΗΣ": "Θέρμη",
                        "ΚΑΛΑΜΑΡΙΑΣ": "Καλαμαριά", "ΚΟΡΔΕΛΙΟΥ": "Κορδελιό", "ΕΥΟΣΜΟΥ": "Εύοσμος",
                        "ΛΑΓΚΑΔΑ": "Λαγκαδάς", "ΝΕΑΠΟΛΗΣ": "Νεάπολη", "ΣΥΚΕΩΝ": "Συκιές",
                        "ΠΥΛΑΙΑΣ": "Πυλαία", "ΧΟΡΤΙΑΤΗ": "Χορτιάτης", "ΩΡΑΙΟΚΑΣΤΡΟΥ": "Ωραιόκαστρο",

                        // ΚΕΝΤΡΙΚΗ ΜΑΚΕΔΟΝΙΑ
                        "ΑΛΕΞΑΝΔΡΕΙΑΣ": "Αλεξάνδρεια", "ΒΕΡΟΙΑΣ": "Βέροια", "ΝΑΟΥΣΑΣ": "Νάουσα",
                        "ΚΙΛΚΙΣ": "Κιλκίς", "ΕΔΕΣΣΑΣ": "Έδεσσα", "ΠΕΛΛΑΣ": "Πέλλα", "ΣΚΥΔΡΑΣ": "Σκύδρα",
                        "ΚΑΤΕΡΙΝΗΣ": "Κατερίνη", "ΣΕΡΡΩΝ": "Σέρρες", "ΠΟΛΥΓΥΡΟΥ": "Πολύγυρος",

                        // ΑΝΑΤ. ΜΑΚΕΔΟΝΙΑ & ΘΡΑΚΗ
                        "ΔΡΑΜΑΣ": "Δράμα", "ΑΛΕΞΑΝΔΡΟΥΠΟΛΗΣ": "Αλεξανδρούπολη", "ΟΡΕΣΤΙΑΔΑΣ": "Ορεστιάδα",
                        "ΚΑΒΑΛΑΣ": "Καβάλα", "ΘΑΣΟΥ": "Θάσος", "ΞΑΝΘΗΣ": "Ξάνθη", "ΚΟΜΟΤΗΝΗΣ": "Κομοτηνή",

                        // ΔΥΤΙΚΗ ΜΑΚΕΔΟΝΙΑ
                        "ΓΡΕΒΕΝΩΝ": "Γρεβενά", "ΚΑΣΤΟΡΙΑΣ": "Καστοριά", "ΚΟΖΑΝΗΣ": "Κοζάνη", "ΦΛΩΡΙΝΑΣ": "Φλώρινα",

                        // ΗΠΕΙΡΟΣ
                        "ΑΡΤΑΣ": "Άρτα", "ΑΡΤΑΙΩΝ": "Άρτα", "ΗΓΟΥΜΕΝΙΤΣΑΣ": "Ηγουμενίτσα",
                        "ΙΩΑΝΝΙΤΩΝ": "Ιωάννινα", "ΙΩΑΝΝΙΝΩΝ": "Ιωάννινα", "ΠΡΕΒΕΖΑΣ": "Πρέβεζα",

                        // ΘΕΣΣΑΛΙΑ
                        "ΚΑΡΔΙΤΣΑΣ": "Καρδίτσα", "ΛΑΡΙΣΑΙΩΝ": "Λάρισα", "ΛΑΡΙΣΑΣ": "Λάρισα", "ΛΑΡΙΣΗΣ": "Λάρισα",
                        "ΒΟΛΟΥ": "Βόλος", "ΤΡΙΚΚΑΙΩΝ": "Τρίκαλα", "ΤΡΙΚΑΛΩΝ": "Τρίκαλα", "ΚΑΛΑΜΠΑΚΑΣ": "Καλαμπάκα",

                        // ΣΤΕΡΕΑ ΕΛΛΑΔΑ
                        "ΘΗΒΑΙΩΝ": "Θήβα", "ΘΗΒΩΝ": "Θήβα", "ΘΗΒΑΣ": "Θήβα", "ΛΕΒΑΔΕΩΝ": "Λιβαδειά",
                        "ΧΑΛΚΙΔΕΩΝ": "Χαλκίδα", "ΧΑΛΚΙΔΑΣ": "Χαλκίδα", "ΚΑΡΠΕΝΗΣΙΟΥ": "Καρπενήσι",
                        "ΛΑΜΙΕΩΝ": "Λαμία", "ΛΑΜΙΑΣ": "Λαμία", "ΔΕΛΦΩΝ": "Δελφοί", "ΑΜΦΙΣΣΑΣ": "Άμφισσα",

                        // ΠΕΛΟΠΟΝΝΗΣΟΣ
                        "ΑΡΓΟΥΣ": "Άργος", "ΝΑΥΠΛΙΕΩΝ": "Ναύπλιο", "ΝΑΥΠΛΙΟΥ": "Ναύπλιο",
                        "ΤΡΙΠΟΛΗΣ": "Τρίπολη", "ΚΟΡΙΝΘΙΩΝ": "Κόρινθος", "ΚΟΡΙΝΘΟΥ": "Κόρινθος",
                        "ΣΠΑΡΤΗΣ": "Σπάρτη", "ΚΑΛΑΜΑΤΑΣ": "Καλαμάτα",

                        // ΔΥΤΙΚΗ ΕΛΛΑΔΑ
                        "ΑΓΡΙΝΙΟΥ": "Αγρίνιο", "ΜΕΣΟΛΟΓΓΙΟΥ": "Μεσολόγγι", "ΠΑΤΡΕΩΝ": "Πάτρα", "ΠΑΤΡΩΝ": "Πάτρα",
                        "ΠΥΡΓΟΥ": "Πύργος",

                        // ΙΟΝΙΑ ΝΗΣΙΑ
                        "ΚΕΡΚΥΡΑΣ": "Κέρκυρα", "ΛΕΥΚΑΔΑΣ": "Λευκάδα", "ΑΡΓΟΣΤΟΛΙΟΥ": "Αργοστόλι",
                        "ΚΕΦΑΛΟΝΙΑΣ": "Κεφαλονιά", "ΖΑΚΥΝΘΟΥ": "Ζάκυνθος", "ΙΘΑΚΗΣ": "Ιθάκη",

                        // ΒΟΡΕΙΟ ΑΙΓΑΙΟ
                        "ΛΕΣΒΟΥ": "Λέσβος", "ΜΥΤΙΛΗΝΗΣ": "Μυτιλήνη", "ΛΗΜΝΟΥ": "Λήμνος",
                        "ΧΙΟΥ": "Χίος", "ΣΑΜΟΥ": "Σάμος", "ΙΚΑΡΙΑΣ": "Ικαρία",

                        // ΝΟΤΙΟ ΑΙΓΑΙΟ - ΚΥΚΛΑΔΕΣ
                        "ΘΗΡΑΣ": "Θήρα", "ΣΑΝΤΟΡΙΝΗΣ": "Σαντορίνη", "ΜΥΚΟΝΟΥ": "Μύκονος",
                        "ΝΑΞΟΥ": "Νάξος", "ΠΑΡΟΥ": "Πάρος", "ΣΥΡΟΥ": "Σύρος", "ΕΡΜΟΥΠΟΛΗΣ": "Ερμούπολη",
                        "ΤΗΝΟΥ": "Τήνος", "ΑΝΔΡΟΥ": "Άνδρος", "ΜΗΛΟΥ": "Μήλος", "ΚΕΑΣ": "Κέα",

                        // ΝΟΤΙΟ ΑΙΓΑΙΟ - ΔΩΔΕΚΑΝΗΣΑ
                        "ΡΟΔΟΥ": "Ρόδος", "ΚΩ": "Κως", "ΚΑΛΥΜΝΟΥ": "Κάλυμνος", "ΚΑΡΠΑΘΟΥ": "Κάρπαθος",
                        "ΛΕΡΟΥ": "Λέρος", "ΠΑΤΜΟΥ": "Πάτμος", "ΣΥΜΗΣ": "Σύμη",

                        // ΚΡΗΤΗ
                        "ΧΑΝΙΩΝ": "Χανιά", "ΡΕΘΥΜΝΗΣ": "Ρέθυμνο", "ΡΕΘΥΜΝΟΥ": "Ρέθυμνο",
                        "ΛΑΣΙΘΙΟΥ": "Λασίθι", "ΑΓΙΟΥ ΝΙΚΟΛΑΟΥ": "Άγιος Νικόλαος", "ΙΕΡΑΠΕΤΡΑΣ": "Ιεράπετρα",
                        "ΣΗΤΕΙΑΣ": "Σητεία", "ΧΕΡΣΟΝΗΣΟΥ": "Χερσόνησος",

                        // ΠΕΡΙΦΕΡΕΙΕΣ & ΠΕΡΙΦΕΡΕΙΑΚΕΣ ΕΝΟΤΗΤΕΣ
                        "ΑΤΤΙΚΗΣ": "Αττική",
                    ...
                    // Αν έχει κενό (2+ λέξεις), σπάσε και μετέτρεψε κάθε λέξη
                    if (upper.includes(' ')) {
                        return genitive.split(' ')
                            .map(part => genitiveToNominative(part.trim()))
                            .join(' ');
                    ...
                    // Rules για άγνωστες πόλεις
                    let result = genitive.toLowerCase();

                    if (upper.endsWith('ΕΩΣ')) {
                        result = result.slice(0, -3) + 'η';
                    } else if (upper.endsWith('ΡΙΟΥ')) {
                        result = result.slice(0, -4) + 'ρι';
                    } else if (upper.endsWith('ΝΙΟΥ')) {
                        result = result.slice(0, -4) + 'νι';
                    } else if (upper.endsWith('ΙΟΥ')) {
                        result = result.slice(0, -3) + 'ι';
                    } else if (upper.endsWith('ΩΝ')) {
                        result = result.slice(0, -2) + 'α';
                    } else if (upper.endsWith('ΟΥ')) {
                        result = result.slice(0, -2) + 'ο';
                    } else if (upper.endsWith('ΗΣ')) {
                        result = result.slice(0, -2) + 'η';
                    } else if (upper.endsWith('ΑΣ')) {
                        result = result.slice(0, -2) + 'α';
                    }
                ...
                const fields = [
                    ...
                    {
                        label: "Περιοχή",
                        value: genitiveToNominative(data.municipalityCommunity || "")
                    },
                    {
                        label: "ΤΚ",
